class PurchaseAddress
  ...
  def save
    ...
    Address.create(post_code: post_code, sender_area_id: sender_area_id, municipalities: municipalities, street_address: street_address, building_name: building_name, phone_number: phone_number)
  end
